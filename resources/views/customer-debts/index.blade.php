...
@section('admin_title', 'Daftar Piutang Pelanggan')

@section('content_header', 'Daftar Piutang Pelanggan')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('customer-debts.index') }}" class="form-inline">
                        ...
                        <a href="{{ route('customer-debts.index') }}" class="btn btn-secondary mb-2 ml-1">
                            <i class="fa fa-refresh"></i> Reset
                        </a>
                        <a href="{{ route('customer-debts.export', request()->query()) }}" class="btn btn-success mb-2 ml-1">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @else
                    <p class="text-muted">Tidak ada data piutang yang ditemukan.</p>
                    @endif
                </div>
            </div>
        </div>
